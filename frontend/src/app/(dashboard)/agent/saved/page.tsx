...
export default function AgentSavedProperties() {
  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Properties you have bookmarked for reference.</p>
      </div>
      ...
      {properties.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-xl border-2 border-dashed border-slate-300">
          ...
          <p className="text-muted-foreground mb-6">
            Save properties to keep track of market trends and competition!
          </p>
